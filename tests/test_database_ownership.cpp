...
int main() {
    ...
    const QueryResult survivingResult = [&] {
        Database original(originalPath);
        ...
        Database destination(replacedPath);
    ...
    Database reopened(originalPath);
    ...
    Database replaced(replacedPath);
